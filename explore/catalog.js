export const visualizations = [
  ...
  },
  {
    ...
    "instructions": "Hover over the curves to compare years and use the legend to focus on the series you want to examine.",
    "methodology": "Within each year and sex, names are ranked by recorded births. The chart shows the share of all recorded births represented by the Top 10 and Top 100 names.",
    "iframeHeight": 650,
    "embedMode": "scale",
    "embedWidth": 1050,
    "variants": [
  ...
  },
  {
    ...
    "category": "Top Names Over Time",
    "description": "Explore how quickly births become concentrated among the most common names and how frequency falls with all-time rank.",
    "instructions": "Hover along the curves to compare cumulative share and individual-name frequency at different all-time ranks.",
  ...
  },
  {
    ...
    "methodology": "The overview compares the timing of many state-level name trends with their national patterns. State results summarize whether local popularity curves tend to lead or lag the corresponding national curves.",
    "iframeHeight": 730,
    "embedMode": "scale",
    "embedWidth": 1000,
    "variants": [
  ...
  },
  {
    ...
    "methodology": "Each point represents a pair of states. One axis measures physical distance between the states; the other measures how different their overall baby-name distributions are.",
    "iframeHeight": 790,
    "embedMode": "scale",
    "embedWidth": 1100,
    "variants": [
  ...
  },
  {
    ...
    "instructions": "Choose All Sexes, Male, or Female and use the year slider. All time is the default. Hover over a state to see its average score.",
    "methodology": "Each name receives the standard English-language Scrabble letter score, with non-letter characters ignored. State averages weight each name's score by its recorded births. All-time and individual-year maps use separate color ranges so long-term differences remain visible while year-to-year colors stay comparable.",
    "iframeHeight": 750,
    "embedMode": "scale",
    "embedWidth": 1050,
    "variants": [
  ...
  },
  {
    ...
    "methodology": "The first-letter view summarizes recorded births by sex, letter, and time period. The sex-balance view compares female and male shares among names beginning or ending with each letter.",
    "iframeHeight": 700,
    "embedMode": "scale",
    "embedWidth": 1200,
    "variants": [
  ...
  },
  {
    ...
    "methodology": "Each name receives the standard English-language Scrabble score, ignoring non-letter characters. Averages are weighted by recorded births, so common names contribute more than rare names.",
    "iframeHeight": 750,
    "embedMode": "scale",
    "embedWidth": 1200,
    "variants": [
  ...
  },
  {
    ...
    "instructions": "Use the controls in the visualization to change the displayed example or view. Hover over the chart for year-by-year values.",
  ...
  },
  {
    ...
    "methodology": "The comeback score reflects how widely a name's recorded births are spread across birth years, calculated separately by sex. Larger scores indicate a broader time span of use, which can reflect long-lasting popularity, a later revival, or several waves.",
    "iframeHeight": 835,
    "embedMode": "scale",
    "embedWidth": 1200,
    "variants": [
  ...
  },
  {
    ...
    "category": "Correlations",
    "description": "Sketch the popularity pattern you have in mind and find real baby names with similar historical curves.",
    "instructions": "Draw directly in the chart area, choose the comparison settings, and run the matcher. The closest matching names appear in the results panel.",
    "methodology": "The tool compares the shape of your drawing with historical national baby-name popularity curves. Similarity describes the shape of the curve; it does not imply that the matched names are related in meaning, origin, or use.",
    "iframeHeight": 980,
    "embedMode": "fluid",
    "variants": [
      {
  ...
  },
  {
    ...
    "instructions": "Choose Mambo No. 5, USA Dream Team, Friends Cast, or Custom input. In the custom view, enter names separated by commas, semicolons, or line breaks. Use the Frequency/Percentage control in the chart to change how the individual curves are shown.",
    "methodology": "The estimate combines the national popularity histories of the entered first names and asks which birth years make that collection of names most plausible. Duplicate names count more than once, just as they would in a real group.",
    "iframeHeight": 820,
    "embedMode": "scale",
    "embedWidth": 1100,
    "variants": [
  ...
  },
  {
    ...
    "instructions": "Study the hidden curve and choose among four names. You can inspect the line by sex and by Frequency, Percentage, or Rank, or switch to the all-time map. After you answer, the comparison curves are revealed and Next Round appears above the choices.",
  ...
  },
  {
    ...
    "shortTitle": "Matching",
    "category": "Name Identification Game",
    "description": "Match three numbered popularity curves with the three names that produced them.",
    "instructions": "Compare the curves, assign each name to a number, and submit your matches. Use the line controls or all-time map views for additional clues before answering.",
    "methodology": "The prepared Single Curve and Matching rounds use common U.S. names chosen to provide a range of recognizable and challenging popularity patterns. Later rounds include curated themed groups. Frequency and Percentage use linear vertical scales, while Rank uses a logarithmic scale. Map views use all-time state patterns.",
    "iframeHeight": 900,
    "embedMode": "fluid",
    "variants": [
  ...
  },
  {
    ...
    "instructions": "Enter 2–6 names and start the custom game. Use the available line and all-time map views to compare the selected names.",
